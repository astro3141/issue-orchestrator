...
R20 promotion canary record: a self-hosting lifecycle ran on 2026-08-25 under the R20 runtime built from `9efcab66`, the candidate under test being this branch's own HEAD (issue #259) — a dated record only, not operating instructions.
